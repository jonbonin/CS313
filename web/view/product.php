...
<html>
    ...
    <body>
        <div>
            <header role="banner">
                <h1  class="pageTitle">Connect, Create, Collaborate Conference</h1>
                <nav role="navigation">
                    <div>
                        <ul>
                            <li><a href="home.html" Title="Home Page">Home</a></li>
                            <li><a href="homework.html" title="All my Homework">Homework</a></li>
                            <li><a href="describeMe.html" title="How to contact the auther">About Me</a></li>
                            <li><a href="product.html" title="Let's shop">Products</a></li>
                        </ul>
                    </div>
                </nav>
            </header>
                    ...
                    <div>
                        ...
                        <table>
                            ...
                            <tr>
                                ...
                                <th>
                                    <p>
                                        This is a fish that can be <a href="/?action=buyTheobald" title="Buy Your Fish!!">bought</a> for a wonderful price.
                                        Now this fish is the best way to fly around when making a dish for a party.
                                        In now way whatsoever can there be a way where this fish will not be appetizing to the folk that you are with.
                                        Come downtown and buy this duck for ten cents on the dollar!!
                                    </p>
                                </th>
                            </tr>
                            <tr>
                                <th><p>Goodman Brown</p></th>
                                <th>
                                    <img src="https://s-media-cache-ak0.pinimg.com/736x/0b/25/34/0b2534091d482a4a2269bd65a972d7c5.jpg">
                                </th>
                                <th>
                                    <p>
                                        Goodman Brown. No other explaination is needed in order to <a href="">buy</a> him downtown.
                                    </p>
                                </th>
                            </tr>
                        </table>
